...
public class EmployeeController {
    ...
    //http://localhost:8080/api/vi/employee/add
    @PostMapping ("/add")
    ...
    //http://localhost:8080/api/vi/employee?id=1
    @DeleteMapping
    ...
    //http://localhost:8080/api/vi/employee?pageNo&pageSize&sortBy=email&sortDir=asc
    @GetMapping
    ...
    //http://localhost:8080/api/vi/employee/employeeById/{empId}
